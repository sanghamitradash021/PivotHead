export default {
  ...
  '__props---pivot-head-docs-category-contribution-guidea-3-d-5d9': [
    () =>
      import(
        /* webpackChunkName: "__props---pivot-head-docs-category-contribution-guidea-3-d-5d9" */ '@generated/docusaurus-plugin-content-docs/default/p/pivot-head-docs-category-contribution-guide-db8.json'
      ),
    '@generated/docusaurus-plugin-content-docs/default/p/pivot-head-docs-category-contribution-guide-db8.json',
    require.resolveWeak(
      '@generated/docusaurus-plugin-content-docs/default/p/pivot-head-docs-category-contribution-guide-db8.json'
    ),
  ],
  '__props---pivot-head-docs-category-tutorials-9-b-3-017': [
    () =>
      import(
        /* webpackChunkName: "__props---pivot-head-docs-category-tutorials-9-b-3-017" */ '@generated/docusaurus-plugin-content-docs/default/p/pivot-head-docs-category-tutorials-12f.json'
      ),
    '@generated/docusaurus-plugin-content-docs/default/p/pivot-head-docs-category-tutorials-12f.json',
    require.resolveWeak(
      '@generated/docusaurus-plugin-content-docs/default/p/pivot-head-docs-category-tutorials-12f.json'
    ),
  ],
  ...
  'content---pivot-head-docs-why-we-use-pivotheada-8-b-7a9': [
    () =>
      import(
        /* webpackChunkName: "content---pivot-head-docs-why-we-use-pivotheada-8-b-7a9" */ '@site/docs/Why-we-use-pivothead.md'
      ),
